...
class fontconfig(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.send('curl -L http://www.freedesktop.org/software/fontconfig/release/fontconfig-2.11.1.tar.bz2 | bunzip2 -c | tar -xf -')
...
def module():
	return fontconfig(
		...
		description='',
		maintainer='',
		depends=['shutit.tk.sd.expat.expat','shutit.tk.sd.freetype.freetype']
	)
