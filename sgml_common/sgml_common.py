...
class sgml_common(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.send('curl -L ftp://sources.redhat.com/pub/docbook-tools/new-trials/SOURCES/sgml-common-0.6.3.tgz | tar -zxf -')
		shutit.send('cd sgml-common*')
		shutit.send('curl -L http://www.linuxfromscratch.org/patches/blfs/7.6/sgml-common-0.6.3-manpage-1.patch | patch -Np1 -i -')
