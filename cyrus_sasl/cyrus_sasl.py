...
class cyrus_sasl(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.send('curl -L ftp://ftp.cyrusimap.org/cyrus-sasl/cyrus-sasl-2.1.26.tar.gz | tar -zxf -')
		shutit.send('cd cyrus-sasl*')
		shutit.send('curl -L http://www.linuxfromscratch.org/patches/blfs/svn/cyrus-sasl-2.1.26-fixes-3.patch | patch -Np1 -i -')
