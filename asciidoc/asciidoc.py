...
class asciidoc(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.send('curl -L http://downloads.sourceforge.net/project/asciidoc/asciidoc/' + shutit.cfg[self.module_id]['version'] + '/asciidoc-' + shutit.cfg[self.module_id]['version'] + '.tar.gz | tar -zxf -')
