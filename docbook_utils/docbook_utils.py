...
class docbook_utils(ShutItModule):
	...
	def build(self, shutit):
		...
		shutit.send('curl -L ftp://sources.redhat.com/pub/docbook-tools/new-trials/SOURCES/docbook-utils-0.6.14.tar.gz | tar -zxf -')
		shutit.send('cd docbook*')
		shutit.send('curl -L http://www.linuxfromscratch.org/patches/blfs/7.6/docbook-utils-0.6.14-grep_fix-1.patch | patch -Np1 -i -')
